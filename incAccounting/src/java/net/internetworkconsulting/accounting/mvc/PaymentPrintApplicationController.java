...
class PaymentPrintApplicationController extends Controller{
	...
	public PaymentPrintApplicationController(ControllerInterface controller, String document_keyword) { super(controller, document_keyword); }
