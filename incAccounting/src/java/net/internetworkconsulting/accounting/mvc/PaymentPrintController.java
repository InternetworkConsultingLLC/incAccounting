...
public class PaymentPrintController extends Controller {
	...
	public PaymentPrintController(ControllerInterface controller, String document_keyword) { super(controller, document_keyword); }
	...
	private PaymentPrintApplicationController createApplicationController(PaymentApplicationSelection app) {
		PaymentPrintApplicationController peac = new PaymentPrintApplicationController(this, "Application");
	...
	private void LoadApplicationSelections() throws Exception {
		...
		if(objModel.getPaymentTypesGuid() != null && objModel.getContactsGuid() != null) {
			List<PaymentApplicationSelection> lstApplications = objModel.loadPaymentApplicationSelection(getUser().login(), false);
			for(PaymentApplicationSelection app: lstApplications) {
				PaymentPrintApplicationController paec = createApplicationController(app);
