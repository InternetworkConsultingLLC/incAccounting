...
public class ContactEditChildController extends Controller {
	public ContactEditChildController(ControllerInterface controller, String document_keyword) { super(controller, document_keyword); }
