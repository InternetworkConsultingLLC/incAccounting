...
public class DepositEditPaymentController extends Controller {
	private Payment objModel;
	private CheckTag chkIncluded;

	public DepositEditPaymentController(ControllerInterface controller, String document_keyword) { super(controller, document_keyword); }
