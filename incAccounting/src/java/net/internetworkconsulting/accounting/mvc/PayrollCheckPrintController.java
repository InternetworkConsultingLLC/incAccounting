...
public class PayrollCheckPrintController extends Controller {
	private PayrollCheck objModel;
	private ButtonTag btnTemplate;
	public PayrollCheckPrintController(ControllerInterface controller, String document_keyword) { super(controller, document_keyword); }
	...
	private PayrollCheckPrintFieldController createFieldController(PayrollFieldValue objField, String sBlock, String sFieldTypeLimit) throws Exception {
		if(sFieldTypeLimit == null)
			throw new Exception("Field type limit not specified!");

		PayrollCheckPrintFieldController pcefc = new PayrollCheckPrintFieldController(this, sBlock);
