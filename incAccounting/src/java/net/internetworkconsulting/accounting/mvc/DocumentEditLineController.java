...
public class DocumentEditLineController extends Controller {
	public DocumentEditLineController(ControllerInterface controller, String document_keyword) { super(controller, document_keyword); }
