...
public class PayrollCheckPrintFieldController extends Controller {
	...
	public PayrollCheckPrintFieldController(ControllerInterface controller, String document_keyword) { super(controller, document_keyword); }
