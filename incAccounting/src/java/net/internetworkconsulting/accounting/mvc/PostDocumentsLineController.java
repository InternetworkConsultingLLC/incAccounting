...
public class PostDocumentsLineController extends Controller {
	private CheckTag chkIsPosted;
	public PostDocumentsLineController(ControllerInterface controller, String document_keyword) { super(controller, document_keyword); }
