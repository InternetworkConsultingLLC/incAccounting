...
public class PostDepositsController extends Controller {
	...
	private LinkedList<PostDepositsLineController> lstControllers;
	...
	private PostDepositsLineController createController(Deposit deposit) {
		PostDepositsLineController controller = new PostDepositsLineController(this, "Row");
	...
	private void btnProcess_OnClick() throws Exception {
		try {
			...
			for(PostDepositsLineController controller: lstControllers) {
