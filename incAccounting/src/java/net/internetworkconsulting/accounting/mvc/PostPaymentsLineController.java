...
public class PostPaymentsLineController extends Controller {
	private CheckTag chkIsPosted;
	public PostPaymentsLineController(ControllerInterface controller, String document_keyword) { super(controller, document_keyword); }
