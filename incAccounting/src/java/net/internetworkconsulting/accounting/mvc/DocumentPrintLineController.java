...
public class DocumentPrintLineController extends Controller {
	public DocumentPrintLineController(ControllerInterface controller, String document_keyword) { super(controller, document_keyword); }
