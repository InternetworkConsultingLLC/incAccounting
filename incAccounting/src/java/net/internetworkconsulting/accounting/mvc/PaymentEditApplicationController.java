...
class PaymentEditApplicationController extends Controller{
	...
	public PaymentEditApplicationController(ControllerInterface controller, String document_keyword) { super(controller, document_keyword); }
