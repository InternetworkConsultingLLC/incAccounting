...
public class PayrollFieldEditController extends Controller {
	...
	public void createControls(Template document, Object model) throws Exception {
		...
		if(!getIsPostback()) {
			...
			if(sGuid != null)
				objModel = PayrollField.loadByGuid(getUser().login(), PayrollField.class, sGuid);
			else {
	...
	private void btnSave_OnClick() throws Exception {
		...
		redirect("~/incAccounting?App=PayrollFieldEdit&GUID=" + objModel.getGuid() + "&Error=Saved!");
	}
