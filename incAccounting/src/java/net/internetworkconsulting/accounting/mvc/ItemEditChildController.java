...
public class ItemEditChildController extends Controller {
	private ButtonTag btnOpen;
	public ItemEditChildController(ControllerInterface controller, String document_keyword) { super(controller, document_keyword); }
	...
	private void btnOpen_OnClick() throws Exception {
		Item objModel = (Item) getModel();
		redirect("~/incAccounting?App=ItemEdit&GUID=" + objModel.getGuid());
	}
