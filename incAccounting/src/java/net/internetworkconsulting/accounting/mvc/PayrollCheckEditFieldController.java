...
public class PayrollCheckEditFieldController extends Controller {
	...
	public PayrollCheckEditFieldController(ControllerInterface controller, String document_keyword) { super(controller, document_keyword); }
