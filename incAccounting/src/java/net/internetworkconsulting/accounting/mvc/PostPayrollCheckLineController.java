...
public class PostPayrollCheckLineController extends Controller {
	private CheckTag chkIsPosted;
	public PostPayrollCheckLineController(ControllerInterface controller, String document_keyword) { super(controller, document_keyword); }
