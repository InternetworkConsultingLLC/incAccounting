...
public class JobEditChildController extends Controller{
	private ButtonTag btnOpen;
	public JobEditChildController(ControllerInterface controller, String document_keyword) { super(controller, document_keyword); }
	...
	private void btnOpen_OnClick() throws Exception {
		...
		if(objModel.getParentJobsGuid() != null)
			redirect("~/incAccounting?App=JobEdit&GUID=" + objModel.getGuid());
	}
