...
public class DepositPrintPaymentController extends Controller {
	private Payment objModel;
	private CheckTag chkIncluded;

	public DepositPrintPaymentController(ControllerInterface controller, String document_keyword) { super(controller, document_keyword); }
