...
public class ReconciliationEditLineController extends Controller {
	private CheckTag chkCleared;
	private Reconciliation objReconciliation;

	public ReconciliationEditLineController(ControllerInterface controller, String document_keyword) { super(controller, document_keyword); }
