...
public class AccountEditChildController extends Controller {
	private ButtonTag btnOpen;

	public AccountEditChildController(ControllerInterface controller, String document_keyword) { super(controller, document_keyword); }
...
//		lnkOpen.setUrl("~/AccountEdit?GUID=" + objModel.getGuid());
	...
	private void btnOpen_OnClick() throws Exception {
		Account objModel = (Account) getModel();
		redirect("~/incAccounting?App=AccountEdit&GUID=" + objModel.getGuid());
	}
