...
public class ChildReportFiltersController extends Controller {
	public ChildReportFiltersController(ControllerInterface controller, String document_keyword) { super(controller, document_keyword); }	
