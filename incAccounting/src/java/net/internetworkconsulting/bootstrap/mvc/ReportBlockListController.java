...
public class ReportBlockListController extends Controller {
	public ReportBlockListController(ControllerInterface controller, String document_keyword) { super(controller, document_keyword); }	
