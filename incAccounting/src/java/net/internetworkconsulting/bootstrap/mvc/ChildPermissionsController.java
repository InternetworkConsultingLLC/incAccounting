...
public class ChildPermissionsController extends Controller {
	public ChildPermissionsController(ControllerInterface controller, String document_keyword) { super(controller, document_keyword); }
