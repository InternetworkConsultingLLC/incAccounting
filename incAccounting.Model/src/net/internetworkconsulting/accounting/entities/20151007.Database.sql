...
ALTER TABLE "Document Lines" CHANGE COLUMN "Description" "Description" VARCHAR(255) NOT NULL;
UPDATE "Transaction Types" SET "List URL"='~/incAccounting?App=RegisterEntries' WHERE "GUID"='38ec8da627f345eb9f0639c0931d5db8';
UPDATE "Transaction Types" SET "Edit URL"='~/incAccounting?App=RegisterEntries' WHERE "GUID"='38ec8da627f345eb9f0639c0931d5db8';

UPDATE "Settings" SET "Value" = '2017.3.18' WHERE "Key" = 'Version Number'
