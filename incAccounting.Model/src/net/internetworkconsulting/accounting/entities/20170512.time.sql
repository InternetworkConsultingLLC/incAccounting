...
INSERT INTO "report filters" ("GUID", "Reports GUID", "Prompt", "Data Type", "Query", "Priority") VALUES ('dd37d238585c4df7a587ab362aa3c24f','8fdb0c8bbfb84ead88aed2ee3674b498','Starting','Date','SELECT DATE_ADD(DATE(NOW()), INTERVAL -12 MONTH) AS \"Value\"',2);
