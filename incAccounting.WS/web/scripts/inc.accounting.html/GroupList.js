...
new function() {
	window.onload = function() {
		new inc.accounting.html.Menu("Group List");
	...
	inc.accounting.html.UserList = function() {
		...
		var btnAdd_OnClick = function() { window.location.href = "GroupEdit.html"; };
		...
		var btnSearch_OnClick = function() {
			...
			inc.accounting.business.GroupEntity.loadSearch(sName, bIsAllowed, btnSearch_Callback);
		};
