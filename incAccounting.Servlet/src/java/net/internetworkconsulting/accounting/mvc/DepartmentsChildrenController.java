...
public class DepartmentsChildrenController extends Controller{
	private ButtonTag btnOpen;
	public DepartmentsChildrenController(ControllerInterface controller, String document_keyword) { super(controller, document_keyword); }
	...
	private void btnOpen_OnClick() throws Exception {
		...
		if(objModel.getParentDepartmentsGuid() != null)
			redirect("~/incAccounting?App=Department&GUID=" + objModel.getGuid());
	}
