...
public class DocumentsPrintController extends Controller {
	public DocumentsPrintController(ControllerInterface controller, String document_keyword) { super(controller, document_keyword); }
	private DocumentsLinesPrintController createController(DocumentLine line) {
		Document objModel = (Document) getModel();
		
		DocumentsLinesPrintController delc = new DocumentsLinesPrintController(this, "Row");
		delc.setModel(line);
