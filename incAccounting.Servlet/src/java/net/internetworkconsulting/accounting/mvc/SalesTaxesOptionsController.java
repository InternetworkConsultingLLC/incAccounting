...
public class SalesTaxesOptionsController extends Controller {
	public SalesTaxesOptionsController(ControllerInterface controller, String document_keyword) { super(controller, document_keyword); }
